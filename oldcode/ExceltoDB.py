...
# 定義檔案路徑與對應的資料庫表格名稱
excel_file_path = r'D:\\DeltaBox\\OneDrive - Delta Electronics, Inc\\deltaproject\\DEJbackup\\SoftbankExcel\\表單\\SoftBankData.xlsx'
table_mapping = {
...
column_mappings = {
    'Customer Code': {
        'ASP施工店': ('ASP', 'NVARCHAR(255)'),  # (欄位名稱, 資料型別)
    ...
    'Productinfo': {
        ...
        '税抜単価': ('UnitPrice', 'DECIMAL(15,2)'),
        '標準納期': ('Standard_Delivery_Time', 'DECIMAL(15,2)')
    }
}
